<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Administrator.aspx.cs" Inherits="HospitalManagement.Administrator" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table style="width: 90%;" align="center" border="1">
            ...
            <tr>
                <td colspan="3">
                    <img src="images/Nurse.jpg" width="100%" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3">
                    <table style="width:100%">
                        <tr>
                            <td style="width:50%;text-align:right;" colspan="2"><asp:Button Id="BtnReport" runat="server" Text="Report" OnClick="BtnReport_Click"/><asp:Button Id="btnBack" runat="server" Text="Back" OnClick="btnBack_Click" Visible="false"/></td>
            ...
            <tr>
             ...
             <tr>
                <td colspan="3">
                    <div style="height:15px;width:100%;border:none;text-align: center; font-size: larger; font-weight: bold;border:none;">Patient's History</div>
                </td>
            </tr>
            <tr>
                <td colspan="3">
                   ...
                   <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                    GridLines="Vertical" 
                     Visible="true" Width="100%" DataKeyNames="id">
             ...
             <Columns>
                 <asp:TemplateField HeaderText="Action">
                     <ItemTemplate>
                        <asp:ImageButton ID="BtnEdit" ImageUrl="~/images/icon/edit1.ico" Width="30%" runat="server" OnClick="BtnEdit_Click" />
                     </ItemTemplate>
                     <ItemStyle HorizontalAlign="Center" Width="10%"/>
                 </asp:TemplateField>
              <asp:BoundField HeaderText="Patient Name" DataField="patient_name" />
              <asp:BoundField HeaderText="Patient Email" DataField="patient_email" />
              <asp:BoundField HeaderText="Visited Date" DataField="visited_date" />
              <asp:BoundField HeaderText="Temperature" DataField="temp" />
              <asp:BoundField HeaderText="Blood Pressure" DataField="bp" />
                <asp:BoundField HeaderText="Symptoms" DataField="symptoms" />
                 <asp:BoundField HeaderText="Pulse Rate" DataField="pulse" />
            ...
            <tr>
                <td colspan="3" style="text-align:right"> <asp:Button ID="BtnAdd" runat="server" Text="Add Patient" OnClick="BtnAdd_Click" /></td>
            </tr>
            <tr id="Tr_pupdate" runat="server" visible="false">
                <td style="width:30%;border:none;" ></td>
                <td style="border:none;">
                    <table border="0" style="width:100%">
                        <tr>
                            <td style="width:20%"> <asp:Label ID="Label1" runat="server" Text="Patient Name"></asp:Label></td>
                            <td style="width:80%"> <asp:TextBox ID="txtPaname" runat="server"></asp:TextBox></td>
                       </tr>
                         <tr>
                            <td> <asp:Label ID="Label2" runat="server" Text="Temparture"></asp:Label></td>
                            <td> <asp:TextBox ID="txtTemp" runat="server" TextMode="SingleLine"></asp:TextBox>&#8451; Ex: 32
                                <asp:RegularExpressionValidator runat="server" id="rexTemp" controltovalidate="txtTemp" validationexpression="[0-9]+(\.[0-9][0-9]?)?" errormessage="Please enter a number upto two decimal!" />

                            </td>
                       </tr>
                         <tr>
                            <td> <asp:Label ID="Label13" runat="server" Text="Blood Pressure"></asp:Label></td>
                            <td> <asp:TextBox ID="txtbp" runat="server" TextMode="SingleLine"></asp:TextBox>mm Hg Ex: 135/85
                                 <asp:RegularExpressionValidator ID="rexbp" runat="server" ControlToValidate="txtbp" ValidationExpression="^\d{1,3}\/\d{1,3}$" ErrorMessage="Please enter Correct Value!"></asp:RegularExpressionValidator>
                            </td>
                       </tr>
                         <tr>
                            <td></td>
                         ...
                         <tr>
                            <td> <asp:Label ID="Label14" runat="server" Text="Pulse Rate"></asp:Label></td>
                            <td>
                                 <asp:TextBox ID="txtpulse" runat="server" TextMode="SingleLine"></asp:TextBox>bpm Ex: 72
                            <asp:RegularExpressionValidator ID="rexpulse" runat="server" ControlToValidate="txtpulse" ValidationExpression="^\d{1,3}$" ErrorMessage="Please enter number"></asp:RegularExpressionValidator>
                            </td>
                       </tr>
                         <tr>
                            <td colspan="2" style="text-align:center;"> <asp:Button ID="Button2" runat="server" Text="Update" OnClick="Update"/></td>
                       </tr>
                        </table>
                    </td>
                 <td style="width:10%;border:none;" ></td>
            </tr>
            <tr id="Tr_Save" runat="server" visible="false">
                <td style="width:30%;border:none;" ></td>
                <td style="border:none;">
              <table border="0" style="width:100%">
                   <tr>
                       <td>
                            <asp:Label ID="Label15" runat="server" Text="Patient Name"></asp:Label>
                       </td>
                       <td>
                   ...
                   <tr>
                       <td>
                            <asp:Label ID="Label16" runat="server" Text="Patient Email"></asp:Label>
                       </td>
                       <td>
                            <asp:TextBox ID="txtPaemail" runat="server" TextMode="Email"></asp:TextBox>
                       </td>
                   </tr>
                   <tr>
                       <td>
                       ...
                       <td>
                            ...
                            <cc1:CalendarExtender ID="CalendarExtender15" runat="server" TargetControlID="txtDat" />
                       </td>
                   </tr>
                   <tr>
                       <td>
                            <asp:Label ID="Label18" runat="server" Text="Temparture"></asp:Label>
                       </td>
                       <td>
                            <asp:TextBox ID="txttemperature" runat="server" TextMode="SingleLine"></asp:TextBox>&#8451; Ex: 32.00
            <asp:RegularExpressionValidator runat="server" ID="RegularExpressionValidator1" ControlToValidate="txtTemp" ForeColor="Red" ValidationExpression="[0-9]+(\.[0-9][0-9]?)?" ErrorMessage="Please enter a number upto two decimal!" />
                       </td>
                   </tr>
                   <tr>
                       <td>
                            <asp:Label ID="Label19" runat="server" Text="Blood Pressure"></asp:Label>
                       </td>
                       <td>
                            <asp:TextBox ID="txtBloodPre" runat="server" TextMode="SingleLine"></asp:TextBox>mm Hg Ex: 135/85
         <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtbp" ForeColor="Red" ValidationExpression="^\d{1,3}\/\d{1,3}$" ErrorMessage="Please enter Correct Value!"></asp:RegularExpressionValidator>
                       </td>
                   </tr>
                   <tr>
                       <td>
                            <asp:Label ID="Label20" runat="server" Text="Pulse Rate"></asp:Label>
                       </td>
                       <td>
                            <asp:TextBox ID="txtpluserate" runat="server" TextMode="SingleLine"></asp:TextBox>bpm Ex: 72
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ForeColor="Red" ControlToValidate="txtpulse" ValidationExpression="^\d{1,3}$" ErrorMessage="Please enter number"></asp:RegularExpressionValidator>

                       </td>
                   </tr>
                   <tr>
                       <td>
                            <asp:Label ID="Label21" runat="server" Text="Symptoms"></asp:Label>
                       </td>
                       <td>
                            <asp:DropDownList ID="ddlSym" runat="server">
                                <asp:ListItem>---------------------Select-------------------</asp:ListItem>
                                <asp:ListItem>fever</asp:ListItem>
                                <asp:ListItem>sore throat</asp:ListItem>
                                <asp:ListItem>swollen lymph glands in the neck and armpits</asp:ListItem>
                                <asp:ListItem>headache</asp:ListItem>
                                <asp:ListItem>fatigue</asp:ListItem>
                                <asp:ListItem>muscle weakness</asp:ListItem>
                                <asp:ListItem>swollen tonsils</asp:ListItem>
                                <asp:ListItem>night sweats</asp:ListItem>
                   ...
                   <tr>
                       <td>
                            <asp:Label ID="Label22" runat="server" Text="Comments"></asp:Label>
                       </td>
                       <td>
                   ...
                   <tr>
                       <td>
                            <asp:Label ID="Label23" runat="server" Text="Physician/Nurse Name"></asp:Label>
                       </td>
                       <td>
                            <asp:TextBox ID="txtphname" runat="server" TextMode="SingleLine"></asp:TextBox>
                       </td>
                   </tr>
                  <tr>
                       <td>
                   ...
                   <tr>
                       <td>
                            <asp:Label ID="Label24" runat="server" Text="Specialization"></asp:Label>
                       </td>
                       <td>
                            <asp:DropDownList ID="ddlbelongs" runat="server">
                                <asp:ListItem>------------Select-----------</asp:ListItem>
                   ...
                   <tr>
                       <td>
                            <asp:Button ID="btnRecord" runat="server" Text="Record" OnClick="btnRec" OnClientClick="return oConform();" />
                       </td>
                   </tr>
             </table>
                </td>
                                    ...
                                    <asp:View ID="View22" runat="server">
                                        <table style="width:100%;">
                                            <tr>
                                                <td style="text-align:left;"> Show List Of<br />
                                                    <asp:RadioButtonList ID="rdolist" runat="server" AutoPostBack="true" OnSelectedIndexChanged="rdolist_SelectedIndexChanged">
                                <asp:ListItem Value="1">Physicians</asp:ListItem>
                                <asp:ListItem Value="2">Nurses</asp:ListItem>
                                <asp:ListItem Value="3">Staff Members</asp:ListItem>
                                <asp:ListItem Value="4">Patients</asp:ListItem>
                                <asp:ListItem Value="5">Each Patient Details</asp:ListItem>
                          ...
                          <asp:MultiView ID="MultiView" runat="server" ActiveViewIndex="-1">
                                ...
                                <%--Physicians--%>
                                <asp:View ID="Physicians" runat="server">
                                    <asp:GridView ID="GridViewPatientHistory" runat="server" AutoGenerateColumns="False"
                                        GridLines="Vertical"
                                        Visible="true" Width="100%">
                                ...
                                <asp:View ID="View5" runat="server">
                                    <asp:GridView ID="GridViewNurse" runat="server" AutoGenerateColumns="False"
                                        GridLines="Vertical"
                                        Visible="true"  Width="100%">
                                        ...
                                        <AlternatingRowStyle BackColor="#CCCCCC" />
                                        <Columns>
                                            <asp:BoundField HeaderText="Nurse" DataField="physician_name" />
                                ...
                                <asp:View ID="View6" runat="server">
                                    <asp:GridView ID="GridViewStaff" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <AlternatingRowStyle BackColor="#CCCCCC" />
                                        <Columns>
                                            <asp:BoundField HeaderText="Staff" DataField="physician_name" />
                                ...
                                <asp:View ID="View7" runat="server">
                                    <asp:GridView ID="GridViewPatients" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <AlternatingRowStyle BackColor="#CCCCCC" />
                                        <Columns>
                                            <asp:BoundField HeaderText="Patients" DataField="patient_name" />
                                ...
                                <asp:View ID="View8" runat="server">
                                    <asp:GridView ID="GridViewHistory" runat="server" AutoGenerateColumns="False" GridLines="Vertical"  Width="100%">
                                        ...
                                        <Columns>
                                            <asp:BoundField HeaderText="Patient Name" DataField="patient_name" />
                                            <asp:BoundField HeaderText="Patient Email" DataField="patient_email" />
                                            <asp:BoundField HeaderText="Tempreture" DataField="temp" />
                                            <asp:BoundField HeaderText="BP" DataField="bp" />
                                            <asp:BoundField HeaderText="Symptoms" DataField="symptoms" />
                                            <asp:BoundField HeaderText="Pulse" DataField="pulse" />
                                            <asp:BoundField HeaderText="Physician Name" DataField="physician_name" />
                                            <asp:BoundField HeaderText="Belongs To" DataField="ptype" />
